...
{
  imports = [
    # Hardware config generated by nixos-generate-config during bootstrap
  ...
  # Bootloader
  # This host is installed/booted in legacy BIOS mode (no UEFI ESP mounted).
  ...
  # Networking
  # Hostname is set in modules/hostname.nix (auto-generated by bootstrap)
